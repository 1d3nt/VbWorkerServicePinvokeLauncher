Namespace CoreServices.ProcessManagement
    ...
    Friend Class ProcessInfoRetriever
        ...
        ''' </returns>
        ''' <remarks>
        ''' This method retrieves the process ID from a list of processes that match the specified name and are running in the given session. 
        ''' The result is cast to a <c>UInteger</c>.
        ''' 
